...
export function toMaterial(r: Row): Material {
  return {
    ...
    metriPressoTerzisti: num(r.metriPressoTerzisti),
    metriScampoli: num(r.metriScampoli),
...
export function toAccessory(r: Row): Accessory {
  return {
    ...
    quantitaPressoTerzisti: num(r.quantitaPressoTerzisti),
    quantitaScampoli: num(r.quantitaScampoli),
